...
export class PdfGeneratorService {
  ...
  async generateInvoicePdf(invoice: any): Promise<void> {
    ...
    doc.setFontSize(9);
    doc.text('LumiNex Authorized', 15, sigY - 4);
    doc.text('Digitally Verified Payment', 15, sigY + 6);

    doc.setFontSize(10);
    doc.text('Thank you for choosing LumiNex!', 105, 270, { align: 'center' });
