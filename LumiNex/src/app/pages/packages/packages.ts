  ...
  packages = [
    {
      ...
      price: 3499, currency: '$', period: 'one-time', icon: 'bi-rocket-takeoff',
    ...
    },
    {
      ...
      price: 1499, currency: '$', period: 'one-time', icon: 'bi-graph-up-arrow',
    ...
    },
    {
      ...
      price: 499, currency: '$', period: 'one-time', icon: 'bi-globe2',
    ...
    },
    {
      ...
      price: 999, currency: '$', period: 'one-time', icon: 'bi-bag-check',
    ...
    },
    {
      ...
      price: 299, currency: '$', period: '/month', icon: 'bi-megaphone-fill',
    ...
    },
    {
      ...
      price: 399, currency: '$', period: 'one-time', icon: 'bi-file-earmark-check',
    ...
    },
    {
      ...
      price: 249, currency: '$', period: 'one-time', icon: 'bi-palette-fill',
    ...
    },
    {
      ...
      price: 4999, currency: '$', period: 'from', icon: 'bi-building-gear',
